"""
SAML Response Generator - Signs ASSERTION instead of Response
This version signs the Assertion element, which is what Okta typically expects
"""
import base64
import uuid
...
def create_saml_response_simple(entity_id, acs_url, request_id, audience, user_email,
    ...
    """Create SAML Response - Signs the ASSERTION instead of Response"""
    ...
    # Sign the ASSERTION instead of the Response
    if cert and key:
        ...
        if assertion_elem is not None:
            print(f"[DEBUG] Signing Assertion with ID: {assertion_elem.get('ID')}")
            ...
            print("[DEBUG] ✓ Assertion signed successfully")
        else:
            print("[DEBUG] ⚠️  Warning: Assertion element not found!")
